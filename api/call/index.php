...
switch ($_POST['action']) {
    ...
    case 'status_call':
        ...
        $channel = explode(';', $fullChannel)[0]; // Strip the ;2 or ;1 suffix
        try {
            // call status details
            $statusDetails = [
            ...
            $escapedChannel = escapeshellarg($channel);
            $output = shell_exec("/usr/sbin/asterisk -rx 'core show channel $escapedChannel'");
            ...
            json_error("Error: " . $th->getMessage());
        }
