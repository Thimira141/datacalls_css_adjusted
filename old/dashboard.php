...
// Database connection for username and magnus_user_id
$host = 'localhost';
...
try {
    ...
    // Fetch username and magnus_user_id from users table
...
<head>
    ...
    <!-- Custom Styles -->
    <link href="assets/css/page-specific/dashboard.css" rel="stylesheet">
</head>
